import { _ as t, l as e } from './MarkdownPage-p1fdV9J8.js';
import { c as i } from './cytoscape.esm-3uhDE42e.js';
import { d as r, g as n } from './react-vendor-BI367zWJ.js';
import { s as o } from './graph-vendor-BuQDEdtN.js';
    ...
    : ((s = 1),
      (t = function () {
        return (function (t) {
            ...
            ((c.prototype.getNodes = function () {
              ...
              (c.prototype.remove = function (t) {
                ...
                if (t instanceof a) {
                  ...
                  if (!(l > -1 && g > -1)) throw "Source and/or target doesn't know this edge!";
                  if (
              ...
              (c.prototype.updateLeftTop = function () {
                for (
                  ...
                  var l = s[h];
                  (r > (t = l.getTop()) && (r = t), o > (e = l.getLeft()) && (o = e));
                }
              ...
              (c.prototype.updateConnected = function () {
                ...
                if (0 != this.nodes.length) {
                  ...
                  for (
                    ...
                    for (var s = (e = (o = r.shift()).getEdges()).length, a = 0; a < s; a++)
            ...
            ((n.calcSeparationAmount = function (t, e, i, r) {
              ...
              (n.getIntersection2 = function (t, e, i) {
                ...
                if (r === o) {
                  ...
                  if (!m)
                    switch (R) {
                      case 1:
                        ((x = y), (G = o + -L / D), (i[2] = G), (i[3] = x));
                        break;
                      case 2:
                        ((G = N), (x = s + T * D), (i[2] = G), (i[3] = x));
                        break;
                      case 3:
                        ((x = A), (G = o + L / D), (i[2] = G), (i[3] = x));
                        break;
                      case 4:
              ...
              (n.getIntersection = function (t, e, i, n) {
                ...
                var o,
                  ...
                  v = n.x,
                  A = n.y;
                return 0 === (u = (o = f - d) * (h = y - v) - (s = A - E) * (a = c - p))
                  ? null
                  : new r(
          ...
          function (t, e, i) {
            function r() {}
            ((r.MAX_VALUE = 2147483647), (r.MIN_VALUE = -2147483648), (t.exports = r));
          },
          function (t, e, i) {
            var r = (function () {
                function t(t, e) {
            ...
            ((c.RANDOM_SEED = 1),
              ...
              (c.prototype.update = function (t) {
                if (null == t) this.update2();
                  ...
                  var e = t;
                  if (null != e.getChild())
                    for (var i = e.getChild().getNodes(), r = 0; r < i.length; r++) update(i[r]);
              ...
              (c.findCenterOfTree = function (t) {
                ...
                for (h = h.concat(i); !n; ) {
                  ...
                  ((i = i.concat(h)), (1 != e.length && 2 != e.length) || ((n = !0), (o = e[0])));
                }
                return o;
              }),
          ...
          function (t, e, i) {
            ...
            ((h.prototype.initParameters = function () {
              ...
              (h.prototype.calcGrid = function (t) {
                ...
                for (var r = new Array(e), n = 0; n < e; n++) r[n] = new Array(i);
                for (n = 0; n < e; n++) for (var o = 0; o < i; o++) r[n][o] = new Array();
                return r;
              }),
            ...
            function (t, e, i) {
              ...
              ((v.prototype.newGraphManager = function () {
                ...
                (v.branchRadialLayout = function (t, e, i, r, n, o) {
                  ...
                  null != e && u--;
                  for (var c, d = 0, p = g.length, y = t.getEdgesBetween(e); y.length > 1; ) {
                    var E = y[0];
                    y.splice(0, 1);
                    var A = g.indexOf(E);
                  ...
                  for (var N = Math.abs(r - i) / u, T = c; d != u; T = ++T % p) {
                    ...
                    if (L != e) {
                      var _ = (i + d * N) % 360,
                        m = (_ + N) % 360;
                      (v.branchRadialLayout(L, t, _, m, n + o, o), d++);
                    }
                  }
                }),
                ...
                (v.prototype.insertNodeToRow = function (t, e, i, r) {
                  var n = r;
                  i == t.rows.length && (t.rows.push([]), t.rowWidth.push(n), t.rowHeight.push(0));
                ...
                (v.prototype.getLongestRowIndex = function (t) {
                  for (var e = -1, i = Number.MIN_VALUE, r = 0; r < t.rows.length; r++)
                    t.rowWidth[r] > i && ((e = r), (i = t.rowWidth[r]));
                  return e;
                }),
                (v.prototype.canAddHorizontal = function (t, e, i) {
                  ...
                  var o,
                    ...
                    a = 0;
                  return (
                    t.rowHeight[r] < i && r > 0 && (a = i + t.verticalPadding - t.rowHeight[r]),
                    (o =
                      t.width - n >= e + t.horizontalPadding
                        ? (t.height + a) / (n + e + t.horizontalPadding)
                        : (t.height + a) / t.width),
                    (a = i + t.verticalPadding),
                    (s = t.width < e ? (t.height + a) / e : (t.height + a) / t.width) < 1 &&
                      (s = 1 / s),
                    o < 1 && (o = 1 / o),
                    o < s
                  );
                ...
                (v.prototype.findPlaceforPrunedNode = function (t) {
                  ...
                  if (s > 0)
                    for (var g = n; g <= o; g++)
                      h[0] += this.grid[g][s - 1].length + this.grid[g][s].length - 1;
                  if (o < this.grid.length - 1)
                    for (g = s; g <= a; g++)
                      h[1] += this.grid[o + 1][g].length + this.grid[o][g].length - 1;
                  if (a < this.grid[0].length - 1)
                    for (g = n; g <= o; g++)
                      h[2] += this.grid[g][a + 1].length + this.grid[g][a].length - 1;
                  if (n > 0)
                    for (g = s; g <= a; g++)
                      h[3] += this.grid[n - 1][g].length + this.grid[n][g].length - 1;
                            ...
                            : 0 == h[1] && 0 == h[2]
                              ...
                              : 0 == h[1] && 0 == h[3]
                                ...
                                : 0 == y
                                  ? 2
                                  : 3;
                  } else e = 4 == u && 0 == d ? (y = Math.floor(4 * Math.random())) : c;
                  0 == e
                    ? r.setCenter(
                        i.getCenterX(),
                        i.getCenterY() -
...
function E(t) {
  return new Promise((r) => {
    const n = o('body').append('div').attr('id', 'cy').attr('style', 'display:none'),
      s = i({
    ...
    (s.layout({ name: 'cose-bilkent', quality: 'proof', styleEnabled: !1, animate: !1 }).run(),
      s.ready((t) => {
        (e.info('Cytoscape ready', t), r(s));
      }));
  });
}
function v(t) {
...
async function N(t, i) {
  ...
  try {
    ...
    const i = await E(t),
      ...
      n = A(i);
    return (
      e.debug(`Layout completed: ${r.length} nodes, ${n.length} edges`),
      { nodes: r, edges: n }
    );
  } catch (r) {
    throw (e.error('Error in cose-bilkent layout algorithm:', r), r);
  }
}
function T(t) {
...
(i.use(p),
  t(f, 'addNodes'),
  t(y, 'addEdges'),
  t(E, 'createCytoscapeInstance'),
  t(v, 'extractPositionedNodes'),
  t(A, 'extractPositionedEdges'),
  t(N, 'executeCoseBilkentLayout'),
  t(T, 'validateLayoutData'));
var L = t(
  async (
    t,
    e,
    ...
    const d = c.insert('g').attr('class', 'subgraphs'),
      p = c.insert('g').attr('class', 'edgePaths'),
      f = c.insert('g').attr('class', 'edgeLabels'),
      y = c.insert('g').attr('class', 'nodes');
      ...
      await Promise.all(
        t.nodes.map(async (e) => {
          if (e.isGroup) {
            ...
            const i = { ...e };
            g[e.id] = i;
            const r = await s(y, e, { config: t.config, dir: t.direction || 'TB' }),
              n = r.node().getBBox();
            ((i.width = n.width),
              (i.height = n.height),
              (i.domId = r),
      ...
      await Promise.all(
        t.edges.map(async (e) => {
          ...
          const i = g[e.start ?? ''],
            o = g[e.end ?? ''];
          if (i && o) {
            const n = v.edges.find((t) => t.id === e.id);
            if (n) {
              a.debug('APA01 positionedEdge', n);
              const s = { ...e },
                l = r(p, s, u, t.type, i, o, t.diagramId);
              h(s, l);
            } else {
              const n = {
                  ...e,
                ...
                s = r(p, n, u, t.type, i, o, t.diagramId);
              h(n, s);
            }
          }
        })
