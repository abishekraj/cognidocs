var e;
import { g as t } from './chunk-55IACEB6-BIPibI9z.js';
...
var R = (function () {
  var e = i(function (e, t, s, i) {
    ...
    n = [1, 5],
    r = [1, 6],
    a = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90],
    l = [1, 22],
    c = [2, 7],
    o = [1, 26],
    h = [1, 27],
    ...
    oe = {
      ...
      performAction: i(function (e, t, s, i, n, r, a) {
        var l = r.length - 1;
        switch (n) {
          case 4:
      ...
      table: [
        { 3: 1, 4: 2, 6: t, 9: s, 11: n, 13: r },
        { 1: [3] },
        { 3: 8, 4: 2, 5: [1, 7], 6: t, 9: s, 11: n, 13: r },
        { 5: [1, 9] },
        { 10: [1, 10] },
        { 12: [1, 11] },
        e(a, [2, 6]),
        { 3: 12, 4: 2, 6: t, 9: s, 11: n, 13: r },
        { 1: [2, 2] },
        {
          4: 17,
          5: l,
        ...
        e(C, [2, 85]),
        e(C, [2, 86]),
        { 62: 69, 65: v, 66: L, 67: x, 68: O, 69: w, 70: M, 71: D },
        { 62: 77, 65: v, 66: L, 67: x, 68: O, 69: w, 70: M, 71: D },
        ...
        { 33: 119, 89: b, 90: T },
        { 33: 120, 89: b, 90: T },
        { 75: $, 78: 121, 79: 82, 80: P, 81: U, 82: V, 83: Y, 84: B, 85: Q, 86: j, 87: H, 88: K },
        e(W, [2, 61]),
        e(W, [2, 63]),
        e(J, [2, 68]),
        e(k, [2, 21]),
      ...
      parse: i(function (e) {
        ...
        ('function' == typeof m.yy.parseError
          ...
          i(R, 'lex'));
        for (var f, _, g, S, I, b, T, k, N = {}; ; ) {
          if (
            ((_ = s[s.length - 1]),
            this.defaultActions[_]
              ? (g = this.defaultActions[_])
              : (null == f && (f = R()), (g = l[_] && l[_][f])),
            void 0 === g || !g.length || !g[0])
          ) {
            var q = '';
            for (I in ((k = []), l[_]))
              this.terminals_[I] && I > 2 && k.push("'" + this.terminals_[I] + "'");
            ((q = y.showPosition
              ? 'Parse error on line ' +
                (o + 1) +
                ':\n' +
          ...
          if (g[0] instanceof Array && g.length > 1)
            throw new Error(
              'Parse Error: multiple actions possible at state: ' + _ + ', token: ' + f
            );
          switch (g[0]) {
            case 1:
              (s.push(f),
            ...
            case 2:
              if (
                ...
                p && (N._$.range = [a[a.length - (b || 1)].range[0], a[a.length - 1].range[1]]),
                void 0 !== (S = this.performAction.apply(N, [c, h, o, m.yy, g[1], r, a].concat(u))))
              )
                return S;
              (b &&
                ((s = s.slice(0, -1 * b * 2)), (r = r.slice(0, -1 * b)), (a = a.slice(0, -1 * b))),
                s.push(this.productions_[g[1]][0]),
                r.push(N.$),
                a.push(N._$),
                (T = l[s[s.length - 2]][s[s.length - 1]]),
                s.push(T));
              break;
            case 3:
              return !0;
    ...
    he = (function () {
      return {
        ...
        performAction: i(function (e, t, s, i) {
          switch (s) {
            case 0:
              return 'title';
            case 1:
  ...
  return ((oe.lexer = he), i(ue, 'Parser'), (ue.prototype = oe), (oe.Parser = ue), new ue());
})();
R.parser = R;
var f = R,
  _ =
      ...
      (e = class {
        constructor() {
          ((this.relations = []),
            ...
            (this.getConfig = i(() => h().requirement, 'getConfig')),
            this.clear(),
        ...
        setCssStyle(e, t) {
          for (const s of e) {
            ...
            if (!t || !e) return;
            for (const s of t)
              s.includes(',') ? e.cssStyles.push(...s.split(',')) : e.cssStyles.push(s);
          }
        }
        setClass(e, t) {
          var s;
          for (const i of e) {
            const e = this.requirements.get(i) ?? this.elements.get(i);
            if (e)
              for (const i of t) {
                e.classes.push(i);
                const t = null == (s = this.classes.get(i)) ? void 0 : s.styles;
        ...
        getData() {
          ...
          const n = h(),
            r = [],
            a = [];
          for (const l of this.requirements.values()) {
            const e = l;
            ((e.id = l.name),
              (e.cssStyles = l.cssStyles),
              (e.cssClasses = l.classes.join(' ')),
              (e.shape = 'requirementBox'),
              (e.look = n.look),
              r.push(e));
          }
          for (const l of this.elements.values()) {
            const e = l;
            ((e.shape = 'requirementBox'),
              (e.look = n.look),
              (e.id = l.name),
          ...
          for (const l of this.relations) {
            let r = 0;
            const c = l.type === this.Relationships.CONTAINS,
              o = {
                id: `${l.src}-${l.dst}-${r}`,
                start:
                  (null == (e = this.requirements.get(l.src)) ? void 0 : e.name) ??
                  (null == (t = this.elements.get(l.src)) ? void 0 : t.name),
                end:
                  (null == (s = this.requirements.get(l.dst)) ? void 0 : s.name) ??
                  (null == (i = this.elements.get(l.dst)) ? void 0 : i.name),
                label: `&lt;&lt;${l.type}&gt;&gt;`,
          ...
          return { nodes: r, edges: a, other: {}, config: n, direction: this.getDirection() };
        }
      }),
      'RequirementDB'
    ),
  ...
  S = {};
m(S, { draw: () => I });
var I = i(async function (e, i, n, r) {
    (u.info('REF0:'), u.info('Drawing requirement diagram (unified)', i));
    const { securityLevel: a, state: l, layout: c } = h(),
      o = r.db.getData(),
      y = t(i, a);
    ((o.type = r.type),
      (o.layoutAlgorithm = E(c)),
      (o.nodeSpacing = (null == l ? void 0 : l.nodeSpacing) ?? 50),
      (o.rankSpacing = (null == l ? void 0 : l.rankSpacing) ?? 50),
    ...
    (p.insertTitle(
      ...
      (null == l ? void 0 : l.titleTopMargin) ?? 25,
      r.db.getDiagramTitle()
    ),
      s(y, 8, 'requirementDiagram', (null == l ? void 0 : l.useMaxWidth) ?? !0));
  }, 'draw'),
  b = {
    parser: f,
    get db() {
