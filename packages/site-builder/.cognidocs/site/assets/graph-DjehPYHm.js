import { al as e, am as t, an as s, ao as i, ap as r } from './MarkdownPage-p1fdV9J8.js';
import {
  a as n,
  c as h,
  k as o,
...
class g {
  constructor(e = {}) {
    ((this._isDirected = !Object.prototype.hasOwnProperty.call(e, 'directed') || e.directed),
      (this._isMultigraph =
        !!Object.prototype.hasOwnProperty.call(e, 'multigraph') && e.multigraph),
      (this._isCompound = !!Object.prototype.hasOwnProperty.call(e, 'compound') && e.compound),
      (this._label = void 0),
      (this._defaultNodeLabelFn = s(void 0)),
      (this._defaultEdgeLabelFn = s(void 0)),
      (this._nodes = {}),
  ...
  setDefaultNodeLabel(e) {
    return (i(e) || (e = s(e)), (this._defaultNodeLabelFn = e), this);
  }
  nodeCount() {
  ...
  sources() {
    var e = this;
    return d(this.nodes(), function (t) {
      return r(e._in[t]);
    });
  }
  sinks() {
  ...
  setNode(e, t) {
    return Object.prototype.hasOwnProperty.call(this._nodes, e)
      ...
      : ((this._nodes[e] = arguments.length > 1 ? t : this._defaultNodeLabelFn(e)),
        this._isCompound &&
          ((this._parent[e] = p), (this._children[e] = {}), (this._children[p][e] = !0)),
        (this._in[e] = {}),
        (this._preds[e] = {}),
        (this._out[e] = {}),
        (this._sucs[e] = {}),
  ...
  setParent(e, t) {
    ...
    if (u(t)) t = p;
      ...
      for (var s = (t += ''); !u(s); s = this.parent(s))
        if (s === e)
  ...
  setDefaultEdgeLabel(e) {
    return (i(e) || (e = s(e)), (this._defaultEdgeLabelFn = e), this);
  }
  edgeCount() {
    return this._edgeCount;
  }
  edges() {
    return _(this._edgeObjs);
  }
  setPath(e, t) {
    var s = this,
      i = arguments;
  ...
  edge(e, t, s) {
    var i =
      1 === arguments.length ? m(this._isDirected, arguments[0]) : b(this._isDirected, e, t, s);
...
((g.prototype._nodeCount = 0), (g.prototype._edgeCount = 0));
export { g as G };
