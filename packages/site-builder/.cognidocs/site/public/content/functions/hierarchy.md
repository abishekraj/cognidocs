...
| :--- | :--- | :------- | :---------- |
| `data` | `Datum` | No | The root specified data. If *data* is a Map, it is implicitly converted to the entry [undefined, *data*], and the children accessor instead defaults to `(d) => Array.isArray(d) ? d[1] : null;`. |
