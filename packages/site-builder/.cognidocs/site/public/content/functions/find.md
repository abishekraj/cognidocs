...
| :--- | :--- | :------- | :---------- |
| `schema` | `Schema` | No | Schema; either the `html` or `svg` export. |
| `value` | `string` | No | An attribute-like or property-like name; it will be passed through `normalize` to hopefully find the correct info. |